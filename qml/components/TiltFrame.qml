...
//
// Ported unchanged from omarchy-tidal: it is presentation with nothing
// service-specific in it. TIDAL's own client tilts the sleeve under the cursor
// and runs a sheen across it, and on a page whose whole subject is a record it
// is the one flourish worth having: the artwork stops being a picture of an
// object and starts behaving like one.
//
